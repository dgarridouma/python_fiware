# This example is just to check the status of commands sent when used (mostly) in a NodeMCU
import requests
import json
import os
...
url = 'http://localhost:1026/v2/entities/urn:ngsi-ld:Bell:001?type=Bell'
