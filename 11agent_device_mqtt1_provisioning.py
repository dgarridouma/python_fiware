...
# for data from a device using MQTT
...
json_dict={
  "services": [
   {
     "apikey":      "11jggokgpepnvsb2uv4s40d59ov",
...
json_dict={
 "devices": [
   {
     "device_id":   "vehicle011",
     "entity_name": "urn:ngsi-ld:Vehicle:011",
     "entity_type": "Vehicle",
...
while True:
  ...
  url = 'http://'+ORION_HOST+':1026/v2/entities/urn:ngsi-ld:Vehicle:011?options=keyValues&type=Vehicle'
