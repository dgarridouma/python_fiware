# Send command to devices of #09 examples
import requests
import json
import os
import random
...
url = 'http://'+ORION_HOST+':1026/v2/entities/urn:ngsi-ld:Vehicle:009/attrs/cmd?type=Vehicle' # type=Vehicle seems necessary
                                                                                              # to transmit "value"
